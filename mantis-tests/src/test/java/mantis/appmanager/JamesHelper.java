...
/**
 * Created by Митрич on 03.05.2017.
 */
public class JamesHelper {
  ...
  public  JamesHelper(ApplicationManager app) {
    this.app = app;
    telnet = new TelnetClient(); //создаётся telnet client
  ...
  private Folder openInbox(String username, String password) throws MessagingException {
    //берем почтовую сессию которая была созадна в конструкторе и говорим что протокол POP3
    store = mailSession.getStore("pop3");
    store.connect(mailServer,username,password); //устан соед
